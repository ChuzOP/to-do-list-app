...
export default function SignInSide() {
  ...
  const handleSubmit = (event) => {
    ...
    let emailAdress = localStorage.getItem("email-acount").replace(/"/g, "");
        ...
        <ThemeProvider theme={theme}>
          <Grid container component="main" sx={{ height: "100vh" }}>
            ...
            <Grid
              ...
              sx={{
                backgroundImage:
                  "url(https://www.wallpaperflare.com/static/435/240/38/oyasumi-punpun-cityscape-dark-monochrome-wallpaper.jpg)",
